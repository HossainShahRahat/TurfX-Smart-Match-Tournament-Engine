...
import { buildPlayerProfileById } from "@/services/player-profile.service";
...
export async function getPlayerPublicProfile(playerId) {
  await syncAutoGeneratedContent();
  const profile = await buildPlayerProfileById(playerId);
  ...
  return {
    ...
    averagePeerRating: profile.averagePeerRating,
    totalGoals: profile.totalGoals,
    totalMatches: profile.totalMatches,
    manOfTheMatchCount: profile.manOfTheMatchCount,
